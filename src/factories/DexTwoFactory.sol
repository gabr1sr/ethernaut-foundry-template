...
import {IERC20, ERC20} from "openzeppelin-contracts-08/token/ERC20/ERC20.sol";
...
contract DexTwoFactory is Level {
	...
	return IERC20(token1).balanceOf(_instance) == 0 && IERC20(token2).balanceOf(_instance) == 0;
    }
}
